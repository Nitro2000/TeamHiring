...
data class EmpBasicDetail(
    ...
    val experience: Any? = Any(),
    @SerializedName("gender")
    val gender: String? = "",
    @SerializedName("highestQual")
    val highestQual: String? = "",
    @SerializedName("id")
    val id: String? = "",
    ...
    val skills: String? = "",
    @SerializedName("skills_old")
    val skillsOld: Any? = Any(),
